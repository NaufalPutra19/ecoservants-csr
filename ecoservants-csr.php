...
function ecoservants_enqueue_scripts() {
    ...
    wp_enqueue_script('csr-category-cards', plugin_dir_url(__FILE__) . 'assets/js/csr-category-cards.js', array(), null, true); // Enqueue category card selection script (Issue #7)
}
